...
const headerSection = () => {
    ...
    // General info
    // Title
    addRoundedRect(contentX, headerHeight + lineGap + 8, 100, 6, 1, purple_color, purple_color, 0.5);
    textStyle("arial_bold", "bold", white_color);
    addText("Traffic Sign Sensor Status Daily Report", contentX + 2, headerHeight + lineGap + 8 + 4);

    // Generated by
    addRoundedRect(contentX, headerHeight + lineGap + 15, 100, 6, 1, light_purple_color, light_purple_color, 0.5);
    ...
    // Generated date
    addRoundedRect(contentX, headerHeight + lineGap + 22, 100, 6, 1, lighter_purple_color, lighter_purple_color, 0.5);
    textStyle("arial_bold", "bold", dark_gray_color);
    ...
    // From to time
    addRoundedRect(contentX, headerHeight + lineGap + 29, 100, 6, 1, light_purple_color, light_purple_color, 0.5);
    textStyle("arial_bold", "bold", dark_gray_color);
